...
javascript_media_directory = os.path.join(javascript_root_directory, 'javascript_media')  # Subdirectory for specific media files
...
async def get_all_javascript_private(current_user: str = Depends(get_current_user)) -> list[JavaScript]:
    """
    This route handles the retrieval of all the javascript from the database
...
async def get_javascript_by_id_private(_id: str, current_user: str = Depends(get_current_user)) -> JavaScript:
    """
    This route handles the retrieval of one JavaScript by its ID from the database
...
async def add_new_javascript(javascript: JavaScript, current_user: str = Depends(get_current_user)) -> JavaScript | None:
    """
...
async def edit_javascript_by_id_private(_id: str, javascript: JavaScript, current_user: str = Depends(get_current_user)) -> JavaScript | None:
    """
...
async def delete_javascript_by_id_private(_id: str, current_user: str = Depends(get_current_user)):
    """
...
# Upload a media file
@router.post("/media/")
async def upload_javascript_file(file: UploadFile = File(...), current_user: str = Depends(get_current_user)):
    """
...
@router.get('/images/')
async def list_javascript_images():
    """
...
async def delete_javascript_image(filename: str, current_user: str = Depends(get_current_user)):
    """
